...
| Verified production commit   | `6d22b2e18771df7bb2f64b8fb235e09a7d72f7a4` |
...
| ----------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Global Shell                  | VERIFIED | Language switch plus reload persistence, sidebar storage, dynamic destinations, notifications, account Escape focus, logout clearing, mobile menu, skip link, and truthful route context pass. |
